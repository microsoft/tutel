...
class MOELayer(Base):
    ...
    def __init__(self, gate_type, experts: Union[Module, ModuleList], group: Optional[Any] = None) -> None:
        super().__init__()
        ...
        self.gate = gating(model_dim=experts[0].in_features, num_experts=self.world_size * len(experts), use_fp32=True)
