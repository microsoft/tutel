...
static void experts_gemm_forward(const torch::Tensor &B, const torch::Tensor &A, const torch::Tensor &C) {
...
static void experts_gemm_backward_data(const torch::Tensor &B, const torch::Tensor &A, const torch::Tensor &C) {
  cublasHandle_t handle = at::cuda::getCurrentCUDABlasHandle();
...
static void experts_gemm_backward_weight(const torch::Tensor &B, const torch::Tensor &A, const torch::Tensor &C) {
  cublasHandle_t handle = at::cuda::getCurrentCUDABlasHandle();
