...
* Quick Test on Single-GPU:
        ...
        $ python3 -m tutel.examples.helloworld_tutel_ddp --batch_size=16     # Test Tutel-optimized MoE + Tutel DDP distribution (ZeRO on optimizors)
...
* Run Tutel MoE in Distributed Mode:
        ...
        # << Single Node >>
        $ mpiexec -bind-to none -host localhost -x LOCAL_SIZE=8 python3 -m tutel.launcher.run -m tutel.examples.helloworld_tutel_ddp --batch_size=16
